...
window.BANK.push({
  ...
  "groups": {
    "G1": {
      "title": "The ransom of a mischievous boy",
      "passage": "<p>Bill and Sam decided to kidnap the son of a banker to compensate for their business loss. They kidnapped the boy and hid him in a cave. They asked for a ransom of $2,000 to return the boy. <b>16</b>, their plan quickly got out of control. Their young captive <b>17</b> to be a mischievous boy. He viewed the kidnapping as a wonderful camping trip. He demanded that his kidnappers play tiring games with him, such as riding Bill as a horse for nine miles. Bill and Sam were soon desperate and decided to <b>18</b> the little terror. They lowered the price to $1,500. Yet, knowing perfectly well <b>19</b> a troublemaker his son was, the father refused to give them any money. <b>20</b>, he asked the kidnappers to pay him $250 to take the boy back. To persuade the boy to return home, Bill and Sam had to tell him that his father was taking him bear-hunting. The kidnappers finally handed over the boy and $250 to the banker and fled town as quickly as they could.</p>"
    },
    "G2": {
      "title": "The polygraph machine",
      "passage": "<p>A polygraph machine, also known as a “lie detector,” is a common part of criminal investigations. The instrument is used to measure <b>21</b> a person’s body reacts to questions. The theory underlying it is that lying is stressful, and that this stress can be measured and recorded on a polygraph machine.</p><p>When a person takes a polygraph test, four to six wires, called sensors, are <b>22</b> to different parts of his body. The sensors pick up signals from the person’s blood pressure, pulse, and perspiration. <b>23</b> the process of questioning, all the signals are recorded on a single strip of moving paper. Once the questions are finished, the examiner analyzes the results to determine if the person tested <b>24</b> truthful.</p><p>Well-trained examiners can usually detect lying with a high degree of <b>25</b> when they use a polygraph. However, because different people behave differently when lying, a polygraph test is by no means perfect.</p>"
    },
    "G3": {
      "title": "International trade",
      "passage": "<p>International trade is the exchange of goods and services between countries. Trade is driven by different production costs in different countries, making <b>26</b> cheaper for some countries to import goods rather than make them. A country is said to have a comparative advantage over another when it can produce a commodity more cheaply. This comparative advantage is <b>27</b> by key factors of production such as land, capital, and labor.</p><p>While international trade has long been conducted in history, its economic, social, and political importance has been <b>28</b> in recent centuries. During the 1990s, international trade grew by nearly 8.6% each year. In the year 1990 alone, the growth in trade in services was as high as 19%.</p><p>Today, all countries are involved in, and to varying degrees dependent on, trade with other countries. <b>29</b> international trade, nations would be limited to the goods and services produced within their own borders. Trade is certainly a main <b>30</b> force for globalization. It is also the subject of many international agreements that aim to govern and facilitate international trade, such as those negotiated through the World Trade Organization (WTO).</p>"
    },
    "G4": {
      "title": "Abdul Kareem’s man-made forest",
      "passage": "<p>Are forests always created by nature? A man from rural India proves that this is not necessarily <b>31</b>.</p><p>Abdul Kareem, who used to be an airline ticketing agent, has a great love for the woods. Though he never went to college, he can talk about plants and trees like an expert. In 1977, he bought a piece of rocky wasteland with the <b>32</b> of growing trees on it. In the beginning, people thought he was <b>33</b> to waste his time and money on the land. But he simply <b>34</b> them and kept working on the soil and planting trees there. The land was so <b>35</b> that it had to be watered several times a day. Kareem had to fetch the water from a source that was a kilometer away. In the first two years, none of the trees he planted <b>36</b>. However, in the third year, several young trees started growing. Greatly <b>37</b> by the result, Kareem planted more trees and his man-made forest began to take shape.</p><p>Kareem let his forest grow naturally, without using fertilizers or insecticides. He believed in the ability of nature to renew itself without the <b>38</b> of humans. That’s why he did not allow fallen leaves or twigs from the forest to be removed.</p><p>After years of hard work, Kareem has not only realized his dream but also transformed a piece of <b>39</b> property into a beautiful forest. Today, his forest is home to 1,500 medicinal plants, 2,000 varieties of trees, rare birds, animals, and insects. Now, scientists from all over the world come to visit his <b>40</b>. They hope to find the secret of his success.</p>"
    },
    "G5": {
      "title": "Blood-type beliefs in Japan",
      "passage": "<p>In Japan, a person’s blood type is popularly believed to decide his/her temperament and personality. Type-A people are generally considered sensitive perfectionists and good team players, but over-anxious. Type Os are curious and generous but stubborn. Type ABs are artistic but mysterious and unpredictable, and type Bs are cheerful but eccentric, individualistic, and selfish. Though lacking scientific evidence, this belief is widely seen in books, magazines, and television shows.</p><p>The blood-type belief has been used in unusual ways. The women’s softball team that won gold for Japan at the Beijing Olympics is reported to have used blood-type theories to customize training for each player. Some kindergartens have adopted teaching methods along blood group lines, and even major companies reportedly make decisions about assignments based on an employee’s blood type. In 1990, Mitsubishi Electronics was reported to have announced the formation of a team composed entirely of AB workers, thanks to “their ability to make plans.”</p><p>The belief even affects politics. One former prime minister considered it important enough to reveal in his official profile that he was a type A, while his opposition rival was type B. In 2011, a minister, Ryu Matsumoto, was forced to resign after only a week in office, when a bad-tempered encounter with local officials was televised. In his resignation speech, he blamed his failings on the fact that he was blood type B.</p><p>The blood-type craze, considered simply harmless fun by some Japanese, may manifest itself as prejudice and discrimination. In fact, this seems so common that the Japanese now have a term for it: bura-hara, meaning blood-type harassment. There are reports of discrimination leading to children being bullied, ending of happy relationships, and loss of job opportunities due to blood type.</p>"
    },
    "G6": {
      "title": "Jeanie Low’s Kiddie Stool",
      "passage": "<p>Like many other five-year-olds, Jeanie Low of Houston, Texas, would use a stool to help her reach the bathroom sink. However, the plastic step-stool she had at home was unstable and cluttered up the small bathroom shared by her whole family. After learning of an invention contest held by her school that year, Jeanie resolved to enter the contest by creating a stool that would be a permanent fixture in the bathroom, and yet could be kept out of the way when not in use.</p><p>Jeanie decided to make a stool attached to the bathroom cabinet door under the sink. She cut a plank of wood into two pieces, each about two feet wide and one foot long. Using metal hinges, Jeanie attached one piece of the wood to the front of the cabinet door, and the second piece to the first. The first piece was set just high enough so that when it swung out horizontally from the cabinet door, the second piece would swing down from the first, just touching the ground, and so serving as a support for the first piece of the wood. This created a convenient, sturdy platform for any person too short to reach the sink. When not in use, the hinges allowed the two pieces of wood to fold back up tightly against the cabinet, where they were held in place by magnets. Jeanie called her invention the “Kiddie Stool.”</p><p>Jeanie’s Kiddie Stool won first place in her school’s contest. Two years later, it was awarded first prize again at Houston’s first annual Invention Fair. As a result, Jeanie was invited to make a number of public appearances with her Kiddie Stool, and was featured on local TV as well as in newspapers. Many people found the story of the Kiddie Stool inspiring because it showed that with imagination, anyone can be an inventor.</p>"
    },
    "G7": {
      "title": "Children kept from school by Middle East conflicts",
      "passage": "<p>Ongoing conflicts across the Middle East have prevented more than 13 million children from attending school, according to a report published by UNICEF, the United Nations Children’s Fund.</p><p>The report states that 40% of all children across the region are currently not receiving an education, which is a result of two consequences of violence: structural damage to schools and the displacement of populations, also called “forced migration.” Both issues result from the tide of violence that has crossed the region in recent years. The report examines nine countries where a state of war has become the norm. Across these countries, violence has made 8,500 schools unusable. In certain cases, communities have relied on school buildings to function as shelters for the displaced, with up to nine families living in a single classroom in former schools across Iraq.</p><p>The report pays particularly close attention to Syria, where a bloody civil war has displaced at least nine million people since the war began in 2011. With the crisis now in its fifth year, basic public services, including education, inside Syria have been stretched to breaking point. Within the country, the quality and availability of education depends on whether a particular region is suffering violence.</p><p>The report concludes with an earnest request to international policymakers to distribute financial and other resources to ease the regional crisis. With more than 13 million children already driven from classrooms by conflict, it is no exaggeration to say that the educational prospects of a generation of children are in the balance. The forces that are crushing individual lives and futures are also destroying the prospects for an entire region.</p>"
    },
    "G8": {
      "title": "How sea snakes get fresh water",
      "passage": "<p>Many marine animals, including penguins and marine iguanas, have evolved ways to get rid of excess salt by using special salt-expelling glands around their tongue. However, the sea snake’s salt glands cannot handle the massive amounts of salt that would enter their bodies if they actually drank seawater. This poses a serious problem when it comes to getting enough water to drink. If seawater is not an option, how does this animal survive in the ocean?</p><p>An international team of researchers focused on a population of yellow-bellied sea snakes living near Costa Rica, where rain often does not fall for up to seven months out of the year. Because yellow-bellied sea snakes usually spend all of their time far from land, rain is the animals’ only source of fresh water. When it rains, a thin layer of fresh water forms on top of the ocean, providing the snakes with a fleeting opportunity to lap up that precious resource. But during the dry season when there is no rain, snakes presumably have nothing to drink. Thus, the team became interested in testing whether sea snakes became dehydrated at sea.</p><p>The researchers collected more than 500 yellow-bellied sea snakes and weighed them. They found that during the dry season about half of the snakes accepted fresh water offered to them, while nearly none did during the wet season. A snake’s likelihood to drink also correlated with its body condition, with more withered snakes being more likely to drink, and to drink more. Finally, as predicted, snakes captured during the dry season contained significantly less body water than those scooped up in the rainy season. Thus, it seems the snake is able to endure certain degrees of dehydration in between rains. Scientists believe that dehydration at sea may explain the declining populations of sea snakes in some parts of the world.</p>"
    }
  },
  "questions": [
    {
