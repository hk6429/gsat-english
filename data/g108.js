// 108 學年度學科能力測驗英文考科（單選題 56 題）
// 題目與答案取自大學入學考試中心官方試題及答案；explain 為本站依題面自製解析。
// 官方未提供的統計欄位均省略。
...
window.BANK.push({
  ...
  "groups": {
    "G1": {
      ...
      "passage": "<p>April Fools’ Day, one of the most light-hearted days of the year, has an unclear origin. Some see it as a celebration related to the turn of the seasons from winter to spring; others, however, believe that it <b>16</b> the adoption of a new calendar.</p><p>Ancient cultures celebrated New Year’s Day on or around April 1, which roughly coincides with the beginning of spring. In 1582, Pope Gregory XIII ordered a new calendar, which called for New Year’s Day to be celebrated on January 1. However, many people, either refusing to accept the new date or not having heard about it, <b>17</b> to celebrate New Year’s Day on April 1. Other people began to make fun of these traditionalists, sending them on “fool’s errands” or trying to fool them into believing something false. <b>18</b>, the practice spread throughout Europe and the rest of the world.</p><p>Nowadays, on April Fools’ Day, people often <b>19</b> to create elaborate hoaxes to fool others. Newspapers, radio and TV stations, and websites have participated in the April 1 tradition of making <b>20</b> reports in order to fool their audiences. The BBC once reported that Swiss farmers were experiencing a spaghetti crop and showed scenes of people harvesting noodles from trees. Guess what? Numerous viewers were fooled.</p>"
    },
    "G2": {
      "title": "Leather made from pineapple leaves",
      "passage": "<p>The pineapple, a delicious tropical fruit, has been valued for centuries not only for its distinct and unique taste, but also for its miraculous health and medical benefits. But pineapples can also be a fashionable fruit: Pineapple leaves can <b>21</b> a substitute for leather.</p><p>The idea was developed when a Spanish designer travelling to the Philippines observed a traditional Filipino shirt <b>22</b> together with the fibers of pineapple leaves. After five years of research, she created from pineapple leaves a material which, like real leather, can be used for making bags, shoes, and <b>23</b> textile products. It is an eco-friendly and biodegradable fiber.</p><p>This eco-friendly leather has clear <b>24</b> for the environment, compared to real leather and synthetic leathers. It requires fewer chemicals, making it safer for the workers in factories. Its manufacture also leaves a smaller carbon footprint. In addition, the leftover material following the removal of fibers can even be used as a natural fertilizer back in the pineapple fields.</p><p><b>25</b> its low cost, this innovative material is already being used by many leading fashion companies to make their products.</p>"
    },
    "G3": {
      "title": "Diet-glasses",
      "passage": "<p>Researchers from a university in Japan have developed “diet-glasses” that play tricks with one’s perception of food, which could be helpful to people on a diet. A camera and a viewing system are built <b>26</b> these glasses. As the wearer brings the food toward their mouth, the camera captures an image of the food. It replays the image back through the glasses after processing it on an attached computer. The size of the food they are about to eat is magnified while <b>27</b> of their hand remains normal. Their brain is <b>28</b> tricked into thinking they are eating more than they really are. The study showed that participants who wore the glasses ate 9.3% less than those who did not wear them.</p><p>The team has also developed a special device which uses scent bottles and visual trickery to make the wearers of these glasses think that the plain snack they are eating is <b>29</b> than it actually is. The device, for instance, can be set to <b>30</b> one’s favorite flavor. Recent experiments with this device showed that 80% of the participants were fooled by the smell. For example, some participants thought that they were eating a chocolate snack, but in fact they were not.</p>"
    },
    "G4": {
      "title": "A father with poor memory",
      "passage": "<p>My father started to suffer from memory loss right after his marriage. Or so my mother told us. She said they were married on May 26, while my dad’s memory told him it was June 25. This often <b>31</b> their anniversary celebration, for his rose bouquet always came one month late. Mom seldom asked Dad to go shopping in the traditional market for her. But whenever Dad <b>32</b> on going, she made sure that he brought a shopping list. Dad certainly had the list <b>33</b> when he left for the market, but he would somehow forget it, and then would find it again only after he returned home. Of course, the <b>34</b> that he made were based mainly on his memory of the list. Unfortunately, the items were usually different from Mom’s <b>35</b>.</p><p>My father’s poor memory gave him certain advantages, though. For instance, he was <b>36</b> with many secrets in my family and our community. Because of his poor memory, he had the <b>37</b> of hearing everyone’s private matters. The reason was <b>38</b>: Dad would not remember any of it, we thought. As for our neighbors, they liked to invite my father to dinner so that they could tell him stories about their children, parents, friends, and pets. They also believed the secrets in their families would never be <b>39</b>. They were quite right, for my father cared <b>40</b> about who did what to whom. But there is one thing he would never forget: showing up for dinner on time.</p>"
    },
    "G5": {
      "title": "Angelfish",
      "passage": "<p>Angelfish, often found in the warm seas and coral reefs, are among the most brightly colored fish of the ocean. Brilliant colors and stripes form amazing patterns on their body. These patterns actually help the fish to hide from danger among roots and plants. At night, when these fish become inactive, their colors may become pale. Often, the young ones are differently colored than the adults. Some scientists believe that the color difference between the young and the old indicates their different social positions.</p><p>Another interesting fact about angelfish is that they have an occupation in the fish world. Most of them act as cleaners for other fish and pick dead tissue from their bodies. This is not their food, though. Their diet consists mainly of sponge and algae.</p><p>One particular kind of angelfish, the blackspot angelfish, has a special capability that allows it to change gender from female to male. However, the change is not made at random; it happens for a specific reason. Angelfish live in groups, and each group has one male fish, which is blue in color, and four female fish, which are yellow. The male angelfish is the strongest and largest member of the group. He is the one who protects and looks after the females. When the male dies, the group needs a new “security guard.” This is when the largest female in the group begins to change in appearance. She begins to grow larger in size, and after a week, she starts changing color, from yellow to blue. Slowly, her behavior toward the other fish also changes. She begins behaving like a male. Two weeks later, black stripes appear on her body, indicating the gender change is complete. She is now completely male!</p>"
    },
    "G6": {
      "title": "Totem poles",
      "passage": "<p>Totem poles in North America are poles or posts carved with symbols or figures by Aboriginal peoples of the Northwest Coast. Carved from large, straight trees and painted vibrant colors, the totem poles are not just unique works of art. The coastal peoples have long passed on knowledge from generation to generation through oral traditions, and totem poles were the traditional way of telling the story of an individual family or clan.</p><p>The totem pole can be grouped into specific categories, depending on its location and the occasion for which it was carved. Welcome poles were traditionally placed on village beachfronts to greet visitors arriving by canoe. Inside the homes of high-ranking chiefs is where house poles were found. The family’s history was carefully carved into each pole. Placed along the rear or front walls of a house, house poles also helped to support the main beam of the roof.</p><p>Memorial poles stood in front of a house. They were erected in memory of a deceased chief or a high-ranking clan member. The poles depicted the person’s accomplishments or family history. Mortuary poles were also raised to honor the dead, but they differed from memorial poles, having a burial box placed at the top of the pole. Inside the burial box were the remains of the deceased.</p><p>While many of these poles can still be found in various locations on the west coast of North America, there is one pole that can now only be found in a museum—the shame pole. Traditionally, shame poles were carved for a chief to embarrass and ridicule another who had done something wrong. Once the wrong was made right, the pole was taken down.</p><p>Totem poles are important expressions of specific Aboriginal cultures. Despite the threats posed by cultural and political encroachment of colonial forces, the art of totem pole carving has survived. Aboriginal carvers continue to carve totems as symbols of their cultural pride and clan kinship.</p>"
    },
    "G7": {
      "title": "Earworms",
      "passage": "<p>Music has a tendency to get stuck in our heads. Sometimes a tune intrudes on our thoughts and then plays, and replays, in a never-ending loop. This interesting phenomenon becomes a subject explored by many scientists. They use a range of terms to describe it—stuck-song syndrome, sticky music, cognitive itch, or most commonly “earworm.” Earworms can run around our heads for several minutes to numerous hours. As the melody repeats, it becomes embedded into our mind. Even though our ears do not hear the tune, our brain continues to play it.</p><p>Earworms often take the form of song fragments rather than entire songs, and the song is usually a familiar one. Researchers are not sure why some songs are more likely to get stuck in our heads than others, but everyone has their own tunes. Often those songs have a simple, upbeat melody and catchy, repetitive lyrics, such as popular commercial jingles and slightly annoying radio hits. Recent or repeated exposure to a song or even a small part of a song can also trigger earworms, as can word associations, such as a phrase similar to the lyrics of a song.</p><p>While earworms might be annoying, most people who experience them nevertheless report that they are pleasant or at least neutral. Only a third of people are disturbed by the song in their heads. How people cope with their earworms seems to depend on how they feel about them. Those who have positive feelings about their stuck songs prefer to just “let them be,” while those with negative feelings turn to more behavioral responses, which include coping strategies such as singing, talking, or even praying.</p>"
    },
    "G8": {
      "title": "Foggers and bedbugs",
      "passage": "<p>Got a bug bite problem? Many people who are troubled by skin rashes caused by bug bites use “foggers,” or “bug bombs,” to get rid of the annoying crawlers in their homes. Many people think these bug killers or pesticides will penetrate every place where the insects hide. Actually, quite the opposite is true. Once the pests detect the chemical fog in the room, they’ll hide themselves in walls or other hideaways, where you’ll never be able to treat them effectively.</p><p>Ohio State University researchers tested three commercially sold foggers in a study on the effect of foggers on bedbugs. After testing these brands on five different groups of live bedbugs for two hours, the scientists saw that the foggers had little—if any—effect on the insects. The researchers said bedbugs hide in cracks and crevices such as under sheets and mattresses, or deep in carpets where foggers won’t reach. Moreover, bugs that do come in contact with the mist may be resistant to the pesticide.</p><p>Foggers, or bug bombs, should really be a measure of last resort. First of all, the gases used in bug bombs are highly flammable and thus pose a serious risk of fire or explosion if the product is not used properly. Second, once a bug bomb is used, every surface in your home will be covered with the toxic pesticide. When you use a bug bomb, a chemical mixture rains down on your counters, furniture, floors, and walls, leaving behind oily and toxic substances. Your health might thus be endangered. Therefore, it is suggested that people leave the problem to the professionals.</p>"
    }
  },
  "questions": [
    {
